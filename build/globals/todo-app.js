...
class TodoForm extends jsx_default.a {
	render() {
		IncrementalDOM.elementOpen('form', null, null, 'data-onsubmit', this.handleSubmit.bind(this), 'class', 'todo-form');
		IncrementalDOM.elementOpen('label', null, null, 'for', 'title');
		IncrementalDOM.elementVoid('input', null, null, 'data-onkeyup', this.handleChange.bind(this), 'value', this.state.value, 'placeholder', 'What\'s the next thing?', 'name', 'title');
		IncrementalDOM.elementClose('label');
		IncrementalDOM.elementOpen('button', null, null, 'type', 'submit');
...
class TodoItem extends jsx_default.a {
	render() {
		...
		return [iDOMHelpers.jsxWrapper(function (_handleClick$bind, _checkClass) {
			IncrementalDOM.elementOpen('button', null, null, 'data-onclick', _handleClick$bind, 'class', 'check-item');
			IncrementalDOM.elementOpen('i', null, null, 'class', _checkClass);
			IncrementalDOM.elementClose('i');
			return IncrementalDOM.elementClose('button');
		}, [this.handleClick.bind(this), checkClass]), iDOMHelpers.jsxWrapper(function (_elementClasses, _props$todo$title) {
		...
		}, [elementClasses, this.props.todo.title]), iDOMHelpers.jsxWrapper(function (_handleRemoveElement$) {
			IncrementalDOM.elementOpen('button', null, null, 'data-onclick', _handleRemoveElement$, 'class', 'delete-item');
...
class TodoApp_TodoApp extends jsx_default.a {
	render() {
		IncrementalDOM.elementOpen('div', null, null, 'class', 'todo');
		IncrementalDOM.elementOpen('ul');
		iDOMHelpers.renderArbitrary(this.state.todos.map((todo, index) => {
			return iDOMHelpers.jsxWrapper(function (_todoClick, _index, _todo) {
				return IncrementalDOM.elementVoid(final_TodoItem, null, null, 'events', _todoClick, 'index', _index, 'todo', _todo);
			}, [{
				todoClick: this.handleTodoClick.bind(this)
			}, index, todo]);
		}));
		IncrementalDOM.elementClose('ul');
		IncrementalDOM.elementVoid(final_TodoForm, null, null, 'events', {
...
/* harmony default export */ var final_TodoApp = __webpack_exports__["default"] = (TodoApp_TodoApp);
